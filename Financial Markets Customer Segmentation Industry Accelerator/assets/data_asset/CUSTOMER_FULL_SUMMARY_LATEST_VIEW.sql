...
drop view SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST_VIEW ;

create view SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST_VIEW  as
...
from SCHEMA_NAME.CUSTOMER_SUMMARY
...
DROP TABLE SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST;

CREATE TABLE SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST AS (
select * from SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST_VIEW
) WITH NO DATA;

insert into  SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST
select * from SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST_VIEW;

select count(*) from SCHEMA_NAME.CUSTOMER_FULL_SUMMARY_LATEST; --returns 1000 records
